...
class PParser ( Parser ):
    ...
    ruleNames =  [ "program", "iden", "int_rule", "type_rule", "idenTypeList", 
    ...
    class Int_ruleContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return PParser.RULE_int_rule

        def enterRule(self, listener:ParseTreeListener):
            if hasattr( listener, "enterInt_rule" ):
                listener.enterInt_rule(self)

        def exitRule(self, listener:ParseTreeListener):
            if hasattr( listener, "exitInt_rule" ):
                listener.exitInt_rule(self)
    ...
    def int_rule(self):
        ...
        localctx = PParser.Int_ruleContext(self, self._ctx, self.state)
        self.enterRule(localctx, 4, self.RULE_int_rule)
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 122
    ...
    class SetTypeContext(Type_ruleContext):

        def __init__(self, parser, ctx:ParserRuleContext): # actually a PParser.Type_ruleContext
        ...
        def type_rule(self):
            return self.getTypedRuleContext(PParser.Type_ruleContext,0)
    ...
    class SeqTypeContext(Type_ruleContext):
        ...
        def enterRule(self, listener:ParseTreeListener):
            if hasattr( listener, "enterSeqType" ):
                listener.enterSeqType(self)

        def exitRule(self, listener:ParseTreeListener):
            if hasattr( listener, "exitSeqType" ):
                listener.exitSeqType(self)


    class NamedTypeContext(Type_ruleContext):
    ...
    class TupleTypeContext(Type_ruleContext):

        def __init__(self, parser, ctx:ParserRuleContext): # actually a PParser.Type_ruleContext
            super().__init__(parser)
            self._type_rule = None # Type_ruleContext
            self.tupTypes = list() # of Type_ruleContexts
            self.copyFrom(ctx)
        ...
        def type_rule(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(PParser.Type_ruleContext)
            else:
                return self.getTypedRuleContext(PParser.Type_ruleContext,i)
    ...
    class NamedTupleTypeContext(Type_ruleContext):
        ...
        def enterRule(self, listener:ParseTreeListener):
            if hasattr( listener, "enterNamedTupleType" ):
                listener.enterNamedTupleType(self)

        def exitRule(self, listener:ParseTreeListener):
            if hasattr( listener, "exitNamedTupleType" ):
                listener.exitNamedTupleType(self)


    class PrimitiveTypeContext(Type_ruleContext):
    ...
    class MapTypeContext(Type_ruleContext):

        def __init__(self, parser, ctx:ParserRuleContext): # actually a PParser.Type_ruleContext
            super().__init__(parser)
            self.keyType = None # Type_ruleContext
            self.valueType = None # Type_ruleContext
            self.copyFrom(ctx)
    ...
    def type_rule(self):
        ...
        localctx = PParser.Type_ruleContext(self, self._ctx, self.state)
        self.enterRule(localctx, 6, self.RULE_type_rule)
        self._la = 0 # Token type
        try:
            self.state = 165
            self._errHandler.sync(self)
            ...
            if la_ == 1:
                ...
                self.match(PParser.LBRACK)
                self.state = 136
                localctx.keyType = self.type_rule()
                self.state = 137
                self.match(PParser.COMMA)
                self.state = 138
                localctx.valueType = self.type_rule()
                self.state = 139
                self.match(PParser.RBRACK)
                pass
                ...
                self.state = 142
                localctx._type_rule = self.type_rule()
                localctx.tupTypes.append(localctx._type_rule)
                self.state = 147
                self._errHandler.sync(self)
                _la = self._input.LA(1)
    ...
    class ForeignTypeDefContext(TypeDefDeclContext):
        ...
        def enterRule(self, listener:ParseTreeListener):
            if hasattr( listener, "enterForeignTypeDef" ):
                listener.enterForeignTypeDef(self)

        def exitRule(self, listener:ParseTreeListener):
            if hasattr( listener, "exitForeignTypeDef" ):
                listener.exitForeignTypeDef(self)
    ...
    class PTypeDefContext(TypeDefDeclContext):
        ...
        def enterRule(self, listener:ParseTreeListener):
            if hasattr( listener, "enterPTypeDef" ):
                listener.enterPTypeDef(self)

        def exitRule(self, listener:ParseTreeListener):
            if hasattr( listener, "exitPTypeDef" ):
                listener.exitPTypeDef(self)
    ...
    class EnumTypeDefDeclContext(ParserRuleContext):
        ...
        def enterRule(self, listener:ParseTreeListener):
            if hasattr( listener, "enterEnumTypeDefDecl" ):
                listener.enterEnumTypeDefDecl(self)

        def exitRule(self, listener:ParseTreeListener):
            if hasattr( listener, "exitEnumTypeDefDecl" ):
                listener.exitEnumTypeDefDecl(self)
    ...
    class EnumElemListContext(ParserRuleContext):
        ...
        def enterRule(self, listener:ParseTreeListener):
            if hasattr( listener, "enterEnumElemList" ):
                listener.enterEnumElemList(self)

        def exitRule(self, listener:ParseTreeListener):
            if hasattr( listener, "exitEnumElemList" ):
                listener.exitEnumElemList(self)
    ...
    class EnumElemContext(ParserRuleContext):
        ...
        def enterRule(self, listener:ParseTreeListener):
            if hasattr( listener, "enterEnumElem" ):
                listener.enterEnumElem(self)

        def exitRule(self, listener:ParseTreeListener):
            if hasattr( listener, "exitEnumElem" ):
                listener.exitEnumElem(self)
    ...
    class NumberedEnumElemListContext(ParserRuleContext):
        ...
        def enterRule(self, listener:ParseTreeListener):
            if hasattr( listener, "enterNumberedEnumElemList" ):
                listener.enterNumberedEnumElemList(self)

        def exitRule(self, listener:ParseTreeListener):
            if hasattr( listener, "exitNumberedEnumElemList" ):
                listener.exitNumberedEnumElemList(self)
    ...
    class NumberedEnumElemContext(ParserRuleContext):
        ...
        def enterRule(self, listener:ParseTreeListener):
            if hasattr( listener, "enterNumberedEnumElem" ):
                listener.enterNumberedEnumElem(self)

        def exitRule(self, listener:ParseTreeListener):
            if hasattr( listener, "exitNumberedEnumElem" ):
                listener.exitNumberedEnumElem(self)
    ...
    class EventSetDeclContext(ParserRuleContext):
        ...
        def enterRule(self, listener:ParseTreeListener):
            if hasattr( listener, "enterEventSetDecl" ):
                listener.enterEventSetDecl(self)

        def exitRule(self, listener:ParseTreeListener):
            if hasattr( listener, "exitEventSetDecl" ):
                listener.exitEventSetDecl(self)
    ...
    class EventSetLiteralContext(ParserRuleContext):
        ...
        def enterRule(self, listener:ParseTreeListener):
            if hasattr( listener, "enterEventSetLiteral" ):
                listener.enterEventSetLiteral(self)

        def exitRule(self, listener:ParseTreeListener):
            if hasattr( listener, "exitEventSetLiteral" ):
                listener.exitEventSetLiteral(self)
    ...
    class ImplMachineDeclContext(ParserRuleContext):
        ...
        def enterRule(self, listener:ParseTreeListener):
            if hasattr( listener, "enterImplMachineDecl" ):
                listener.enterImplMachineDecl(self)

        def exitRule(self, listener:ParseTreeListener):
            if hasattr( listener, "exitImplMachineDecl" ):
                listener.exitImplMachineDecl(self)
    ...
    class IdenListContext(ParserRuleContext):
        ...
        def enterRule(self, listener:ParseTreeListener):
            if hasattr( listener, "enterIdenList" ):
                listener.enterIdenList(self)

        def exitRule(self, listener:ParseTreeListener):
            if hasattr( listener, "exitIdenList" ):
                listener.exitIdenList(self)
    ...
    class MachineReceiveContext(ReceivesSendsContext):
        ...
        def enterRule(self, listener:ParseTreeListener):
            if hasattr( listener, "enterMachineReceive" ):
                listener.enterMachineReceive(self)

        def exitRule(self, listener:ParseTreeListener):
            if hasattr( listener, "exitMachineReceive" ):
                listener.exitMachineReceive(self)
    ...
    class MachineSendContext(ReceivesSendsContext):
        ...
        def enterRule(self, listener:ParseTreeListener):
            if hasattr( listener, "enterMachineSend" ):
                listener.enterMachineSend(self)

        def exitRule(self, listener:ParseTreeListener):
            if hasattr( listener, "exitMachineSend" ):
                listener.exitMachineSend(self)
    ...
    class SpecMachineDeclContext(ParserRuleContext):
        ...
        def enterRule(self, listener:ParseTreeListener):
            if hasattr( listener, "enterSpecMachineDecl" ):
                listener.enterSpecMachineDecl(self)

        def exitRule(self, listener:ParseTreeListener):
            if hasattr( listener, "exitSpecMachineDecl" ):
                listener.exitSpecMachineDecl(self)
    ...
    class MachineBodyContext(ParserRuleContext):
        ...
        def enterRule(self, listener:ParseTreeListener):
            if hasattr( listener, "enterMachineBody" ):
                listener.enterMachineBody(self)

        def exitRule(self, listener:ParseTreeListener):
            if hasattr( listener, "exitMachineBody" ):
                listener.exitMachineBody(self)
    ...
    class MachineEntryContext(ParserRuleContext):
        ...
        def enterRule(self, listener:ParseTreeListener):
            if hasattr( listener, "enterMachineEntry" ):
                listener.enterMachineEntry(self)

        def exitRule(self, listener:ParseTreeListener):
            if hasattr( listener, "exitMachineEntry" ):
                listener.exitMachineEntry(self)
    ...
    class ForeignFunDeclContext(FunDeclContext):
        ...
        def enterRule(self, listener:ParseTreeListener):
            if hasattr( listener, "enterForeignFunDecl" ):
                listener.enterForeignFunDecl(self)

        def exitRule(self, listener:ParseTreeListener):
            if hasattr( listener, "exitForeignFunDecl" ):
                listener.exitForeignFunDecl(self)
    ...
    class PFunDeclContext(FunDeclContext):
        ...
        def enterRule(self, listener:ParseTreeListener):
            if hasattr( listener, "enterPFunDecl" ):
                listener.enterPFunDecl(self)

        def exitRule(self, listener:ParseTreeListener):
            if hasattr( listener, "exitPFunDecl" ):
                listener.exitPFunDecl(self)
    ...
    class GroupItemContext(ParserRuleContext):
        ...
        def enterRule(self, listener:ParseTreeListener):
            if hasattr( listener, "enterGroupItem" ):
                listener.enterGroupItem(self)

        def exitRule(self, listener:ParseTreeListener):
            if hasattr( listener, "exitGroupItem" ):
                listener.exitGroupItem(self)
    ...
    class OnEventDoActionContext(StateBodyItemContext):
        ...
        def enterRule(self, listener:ParseTreeListener):
            if hasattr( listener, "enterOnEventDoAction" ):
                listener.enterOnEventDoAction(self)

        def exitRule(self, listener:ParseTreeListener):
            if hasattr( listener, "exitOnEventDoAction" ):
                listener.exitOnEventDoAction(self)
    ...
    class StateExitContext(StateBodyItemContext):
        ...
        def enterRule(self, listener:ParseTreeListener):
            if hasattr( listener, "enterStateExit" ):
                listener.enterStateExit(self)

        def exitRule(self, listener:ParseTreeListener):
            if hasattr( listener, "exitStateExit" ):
                listener.exitStateExit(self)
    ...
    class OnEventGotoStateContext(StateBodyItemContext):
        ...
        def enterRule(self, listener:ParseTreeListener):
            if hasattr( listener, "enterOnEventGotoState" ):
                listener.enterOnEventGotoState(self)

        def exitRule(self, listener:ParseTreeListener):
            if hasattr( listener, "exitOnEventGotoState" ):
                listener.exitOnEventGotoState(self)
    ...
    class StateIgnoreContext(StateBodyItemContext):
        ...
        def enterRule(self, listener:ParseTreeListener):
            if hasattr( listener, "enterStateIgnore" ):
                listener.enterStateIgnore(self)

        def exitRule(self, listener:ParseTreeListener):
            if hasattr( listener, "exitStateIgnore" ):
                listener.exitStateIgnore(self)
    ...
    class StateDeferContext(StateBodyItemContext):
        ...
        def enterRule(self, listener:ParseTreeListener):
            if hasattr( listener, "enterStateDefer" ):
                listener.enterStateDefer(self)

        def exitRule(self, listener:ParseTreeListener):
            if hasattr( listener, "exitStateDefer" ):
                listener.exitStateDefer(self)
    ...
    class OnEventPushStateContext(StateBodyItemContext):
        ...
        def enterRule(self, listener:ParseTreeListener):
            if hasattr( listener, "enterOnEventPushState" ):
                listener.enterOnEventPushState(self)

        def exitRule(self, listener:ParseTreeListener):
            if hasattr( listener, "exitOnEventPushState" ):
                listener.exitOnEventPushState(self)
    ...
    class NonDefaultEventListContext(ParserRuleContext):
        ...
        def enterRule(self, listener:ParseTreeListener):
            if hasattr( listener, "enterNonDefaultEventList" ):
                listener.enterNonDefaultEventList(self)

        def exitRule(self, listener:ParseTreeListener):
            if hasattr( listener, "exitNonDefaultEventList" ):
                listener.exitNonDefaultEventList(self)
    ...
    class NonDefaultEventContext(ParserRuleContext):
        ...
        def enterRule(self, listener:ParseTreeListener):
            if hasattr( listener, "enterNonDefaultEvent" ):
                listener.enterNonDefaultEvent(self)

        def exitRule(self, listener:ParseTreeListener):
            if hasattr( listener, "exitNonDefaultEvent" ):
                listener.exitNonDefaultEvent(self)
    ...
    class EventIdContext(ParserRuleContext):
        ...
        def enterRule(self, listener:ParseTreeListener):
            if hasattr( listener, "enterEventId" ):
                listener.enterEventId(self)

        def exitRule(self, listener:ParseTreeListener):
            if hasattr( listener, "exitEventId" ):
                listener.exitEventId(self)
    ...
    class RemoveStmtContext(StatementContext):
        ...
        def enterRule(self, listener:ParseTreeListener):
            if hasattr( listener, "enterRemoveStmt" ):
                listener.enterRemoveStmt(self)

        def exitRule(self, listener:ParseTreeListener):
            if hasattr( listener, "exitRemoveStmt" ):
                listener.exitRemoveStmt(self)
    ...
    class CtorStmtContext(StatementContext):
        ...
        def enterRule(self, listener:ParseTreeListener):
            if hasattr( listener, "enterCtorStmt" ):
                listener.enterCtorStmt(self)

        def exitRule(self, listener:ParseTreeListener):
            if hasattr( listener, "exitCtorStmt" ):
                listener.exitCtorStmt(self)
    ...
    class AnnounceStmtContext(StatementContext):
        ...
        def enterRule(self, listener:ParseTreeListener):
            if hasattr( listener, "enterAnnounceStmt" ):
                listener.enterAnnounceStmt(self)

        def exitRule(self, listener:ParseTreeListener):
            if hasattr( listener, "exitAnnounceStmt" ):
                listener.exitAnnounceStmt(self)
    ...
    class FunCallStmtContext(StatementContext):
        ...
        def enterRule(self, listener:ParseTreeListener):
            if hasattr( listener, "enterFunCallStmt" ):
                listener.enterFunCallStmt(self)

        def exitRule(self, listener:ParseTreeListener):
            if hasattr( listener, "exitFunCallStmt" ):
                listener.exitFunCallStmt(self)
    ...
    class NoStmtContext(StatementContext):
        ...
        def enterRule(self, listener:ParseTreeListener):
            if hasattr( listener, "enterNoStmt" ):
                listener.enterNoStmt(self)

        def exitRule(self, listener:ParseTreeListener):
            if hasattr( listener, "exitNoStmt" ):
                listener.exitNoStmt(self)
    ...
    class TupleLvalueContext(LvalueContext):
        ...
        def int_rule(self):
            return self.getTypedRuleContext(PParser.Int_ruleContext,0)


        def enterRule(self, listener:ParseTreeListener):
            if hasattr( listener, "enterTupleLvalue" ):
                listener.enterTupleLvalue(self)

        def exitRule(self, listener:ParseTreeListener):
            if hasattr( listener, "exitTupleLvalue" ):
                listener.exitTupleLvalue(self)
    ...
    class NamedTupleLvalueContext(LvalueContext):
        ...
        def enterRule(self, listener:ParseTreeListener):
            if hasattr( listener, "enterNamedTupleLvalue" ):
                listener.enterNamedTupleLvalue(self)

        def exitRule(self, listener:ParseTreeListener):
            if hasattr( listener, "exitNamedTupleLvalue" ):
                listener.exitNamedTupleLvalue(self)
    ...
    class MapOrSeqLvalueContext(LvalueContext):
        ...
        def enterRule(self, listener:ParseTreeListener):
            if hasattr( listener, "enterMapOrSeqLvalue" ):
                listener.enterMapOrSeqLvalue(self)

        def exitRule(self, listener:ParseTreeListener):
            if hasattr( listener, "exitMapOrSeqLvalue" ):
                listener.exitMapOrSeqLvalue(self)
    ...
    class VarLvalueContext(LvalueContext):
        ...
        def enterRule(self, listener:ParseTreeListener):
            if hasattr( listener, "enterVarLvalue" ):
                listener.enterVarLvalue(self)

        def exitRule(self, listener:ParseTreeListener):
            if hasattr( listener, "exitVarLvalue" ):
                listener.exitVarLvalue(self)
    ...
    class RecvCaseContext(ParserRuleContext):
        ...
        def enterRule(self, listener:ParseTreeListener):
            if hasattr( listener, "enterRecvCase" ):
                listener.enterRecvCase(self)

        def exitRule(self, listener:ParseTreeListener):
            if hasattr( listener, "exitRecvCase" ):
                listener.exitRecvCase(self)
    ...
    class AnonEventHandlerContext(ParserRuleContext):
        ...
        def enterRule(self, listener:ParseTreeListener):
            if hasattr( listener, "enterAnonEventHandler" ):
                listener.enterAnonEventHandler(self)

        def exitRule(self, listener:ParseTreeListener):
            if hasattr( listener, "exitAnonEventHandler" ):
                listener.exitAnonEventHandler(self)
    ...
    class NoParamAnonEventHandlerContext(ParserRuleContext):
        ...
        def enterRule(self, listener:ParseTreeListener):
            if hasattr( listener, "enterNoParamAnonEventHandler" ):
                listener.enterNoParamAnonEventHandler(self)

        def exitRule(self, listener:ParseTreeListener):
            if hasattr( listener, "exitNoParamAnonEventHandler" ):
                listener.exitNoParamAnonEventHandler(self)
    ...
    class KeywordExprContext(ExprContext):
        ...
        def enterRule(self, listener:ParseTreeListener):
            if hasattr( listener, "enterKeywordExpr" ):
                listener.enterKeywordExpr(self)

        def exitRule(self, listener:ParseTreeListener):
            if hasattr( listener, "exitKeywordExpr" ):
                listener.exitKeywordExpr(self)
    ...
    class ChooseExprContext(ExprContext):
        ...
        def enterRule(self, listener:ParseTreeListener):
            if hasattr( listener, "enterChooseExpr" ):
                listener.enterChooseExpr(self)

        def exitRule(self, listener:ParseTreeListener):
            if hasattr( listener, "exitChooseExpr" ):
                listener.exitChooseExpr(self)
    ...
    class SeqAccessExprContext(ExprContext):
        ...
        def enterRule(self, listener:ParseTreeListener):
            if hasattr( listener, "enterSeqAccessExpr" ):
                listener.enterSeqAccessExpr(self)

        def exitRule(self, listener:ParseTreeListener):
            if hasattr( listener, "exitSeqAccessExpr" ):
                listener.exitSeqAccessExpr(self)
    ...
    class NamedTupleAccessExprContext(ExprContext):
        ...
        def enterRule(self, listener:ParseTreeListener):
            if hasattr( listener, "enterNamedTupleAccessExpr" ):
                listener.enterNamedTupleAccessExpr(self)

        def exitRule(self, listener:ParseTreeListener):
            if hasattr( listener, "exitNamedTupleAccessExpr" ):
                listener.exitNamedTupleAccessExpr(self)
    ...
    class TupleAccessExprContext(ExprContext):
        ...
        def __init__(self, parser, ctx:ParserRuleContext): # actually a PParser.ExprContext
            super().__init__(parser)
            self.field = None # Int_ruleContext
            self.copyFrom(ctx)
        ...
        def enterRule(self, listener:ParseTreeListener):
            if hasattr( listener, "enterTupleAccessExpr" ):
                listener.enterTupleAccessExpr(self)

        def exitRule(self, listener:ParseTreeListener):
            if hasattr( listener, "exitTupleAccessExpr" ):
                listener.exitTupleAccessExpr(self)
    ...
    class UnnamedTupleExprContext(ExprContext):
        ...
        def enterRule(self, listener:ParseTreeListener):
            if hasattr( listener, "enterUnnamedTupleExpr" ):
                listener.enterUnnamedTupleExpr(self)

        def exitRule(self, listener:ParseTreeListener):
            if hasattr( listener, "exitUnnamedTupleExpr" ):
                listener.exitUnnamedTupleExpr(self)
    ...
    class FunCallExprContext(ExprContext):
        ...
        def enterRule(self, listener:ParseTreeListener):
            if hasattr( listener, "enterFunCallExpr" ):
                listener.enterFunCallExpr(self)

        def exitRule(self, listener:ParseTreeListener):
            if hasattr( listener, "exitFunCallExpr" ):
                listener.exitFunCallExpr(self)
    ...
    class CtorExprContext(ExprContext):
        ...
        def enterRule(self, listener:ParseTreeListener):
            if hasattr( listener, "enterCtorExpr" ):
                listener.enterCtorExpr(self)

        def exitRule(self, listener:ParseTreeListener):
            if hasattr( listener, "exitCtorExpr" ):
                listener.exitCtorExpr(self)
    ...
    class NamedTupleExprContext(ExprContext):
        ...
        def enterRule(self, listener:ParseTreeListener):
            if hasattr( listener, "enterNamedTupleExpr" ):
                listener.enterNamedTupleExpr(self)

        def exitRule(self, listener:ParseTreeListener):
            if hasattr( listener, "exitNamedTupleExpr" ):
                listener.exitNamedTupleExpr(self)
    ...
    class FormatedStringContext(ParserRuleContext):
        ...
        def enterRule(self, listener:ParseTreeListener):
            if hasattr( listener, "enterFormatedString" ):
                listener.enterFormatedString(self)

        def exitRule(self, listener:ParseTreeListener):
            if hasattr( listener, "exitFormatedString" ):
                listener.exitFormatedString(self)
    ...
    class ExpFloatContext(FloatLiteralContext):
        ...
        def enterRule(self, listener:ParseTreeListener):
            if hasattr( listener, "enterExpFloat" ):
                listener.enterExpFloat(self)

        def exitRule(self, listener:ParseTreeListener):
            if hasattr( listener, "exitExpFloat" ):
                listener.exitExpFloat(self)
    ...
    class DecimalFloatContext(FloatLiteralContext):
        ...
        def enterRule(self, listener:ParseTreeListener):
            if hasattr( listener, "enterDecimalFloat" ):
                listener.enterDecimalFloat(self)

        def exitRule(self, listener:ParseTreeListener):
            if hasattr( listener, "exitDecimalFloat" ):
                listener.exitDecimalFloat(self)
    ...
    class AssertModuleExprContext(ModExprContext):
        ...
        def enterRule(self, listener:ParseTreeListener):
            if hasattr( listener, "enterAssertModuleExpr" ):
                listener.enterAssertModuleExpr(self)

        def exitRule(self, listener:ParseTreeListener):
            if hasattr( listener, "exitAssertModuleExpr" ):
                listener.exitAssertModuleExpr(self)
    ...
    class HideInterfacesModuleExprContext(ModExprContext):
        ...
        def enterRule(self, listener:ParseTreeListener):
            if hasattr( listener, "enterHideInterfacesModuleExpr" ):
                listener.enterHideInterfacesModuleExpr(self)

        def exitRule(self, listener:ParseTreeListener):
            if hasattr( listener, "exitHideInterfacesModuleExpr" ):
                listener.exitHideInterfacesModuleExpr(self)
    ...
    class ParenModuleExprContext(ModExprContext):
        ...
        def enterRule(self, listener:ParseTreeListener):
            if hasattr( listener, "enterParenModuleExpr" ):
                listener.enterParenModuleExpr(self)

        def exitRule(self, listener:ParseTreeListener):
            if hasattr( listener, "exitParenModuleExpr" ):
                listener.exitParenModuleExpr(self)
    ...
    class RenameModuleExprContext(ModExprContext):
        ...
        def enterRule(self, listener:ParseTreeListener):
            if hasattr( listener, "enterRenameModuleExpr" ):
                listener.enterRenameModuleExpr(self)

        def exitRule(self, listener:ParseTreeListener):
            if hasattr( listener, "exitRenameModuleExpr" ):
                listener.exitRenameModuleExpr(self)
    ...
    class NamedModuleContext(ModExprContext):
        ...
        def enterRule(self, listener:ParseTreeListener):
            if hasattr( listener, "enterNamedModule" ):
                listener.enterNamedModule(self)

        def exitRule(self, listener:ParseTreeListener):
            if hasattr( listener, "exitNamedModule" ):
                listener.exitNamedModule(self)
    ...
    class PrimitiveModuleExprContext(ModExprContext):
        ...
        def enterRule(self, listener:ParseTreeListener):
            if hasattr( listener, "enterPrimitiveModuleExpr" ):
                listener.enterPrimitiveModuleExpr(self)

        def exitRule(self, listener:ParseTreeListener):
            if hasattr( listener, "exitPrimitiveModuleExpr" ):
                listener.exitPrimitiveModuleExpr(self)
    ...
    class UnionModuleExprContext(ModExprContext):
        ...
        def enterRule(self, listener:ParseTreeListener):
            if hasattr( listener, "enterUnionModuleExpr" ):
                listener.enterUnionModuleExpr(self)

        def exitRule(self, listener:ParseTreeListener):
            if hasattr( listener, "exitUnionModuleExpr" ):
                listener.exitUnionModuleExpr(self)
    ...
    class HideEventsModuleExprContext(ModExprContext):
        ...
        def enterRule(self, listener:ParseTreeListener):
            if hasattr( listener, "enterHideEventsModuleExpr" ):
                listener.enterHideEventsModuleExpr(self)

        def exitRule(self, listener:ParseTreeListener):
            if hasattr( listener, "exitHideEventsModuleExpr" ):
                listener.exitHideEventsModuleExpr(self)
    ...
    class ComposeModuleExprContext(ModExprContext):
        ...
        def enterRule(self, listener:ParseTreeListener):
            if hasattr( listener, "enterComposeModuleExpr" ):
                listener.enterComposeModuleExpr(self)

        def exitRule(self, listener:ParseTreeListener):
            if hasattr( listener, "exitComposeModuleExpr" ):
                listener.exitComposeModuleExpr(self)
    ...
    class MainMachineModuleExprContext(ModExprContext):
        ...
        def enterRule(self, listener:ParseTreeListener):
            if hasattr( listener, "enterMainMachineModuleExpr" ):
                listener.enterMainMachineModuleExpr(self)

        def exitRule(self, listener:ParseTreeListener):
            if hasattr( listener, "exitMainMachineModuleExpr" ):
                listener.exitMainMachineModuleExpr(self)
    ...
    class BindExprContext(ParserRuleContext):
        ...
        def enterRule(self, listener:ParseTreeListener):
            if hasattr( listener, "enterBindExpr" ):
                listener.enterBindExpr(self)

        def exitRule(self, listener:ParseTreeListener):
            if hasattr( listener, "exitBindExpr" ):
                listener.exitBindExpr(self)
    ...
    class NamedModuleDeclContext(ParserRuleContext):
        ...
        def enterRule(self, listener:ParseTreeListener):
            if hasattr( listener, "enterNamedModuleDecl" ):
                listener.enterNamedModuleDecl(self)

        def exitRule(self, listener:ParseTreeListener):
            if hasattr( listener, "exitNamedModuleDecl" ):
                listener.exitNamedModuleDecl(self)
    ...
    class SafetyTestDeclContext(TestDeclContext):
        ...
        def enterRule(self, listener:ParseTreeListener):
            if hasattr( listener, "enterSafetyTestDecl" ):
                listener.enterSafetyTestDecl(self)

        def exitRule(self, listener:ParseTreeListener):
            if hasattr( listener, "exitSafetyTestDecl" ):
                listener.exitSafetyTestDecl(self)
    ...
    class RefinementTestDeclContext(TestDeclContext):
        ...
        def enterRule(self, listener:ParseTreeListener):
            if hasattr( listener, "enterRefinementTestDecl" ):
                listener.enterRefinementTestDecl(self)

        def exitRule(self, listener:ParseTreeListener):
            if hasattr( listener, "exitRefinementTestDecl" ):
                listener.exitRefinementTestDecl(self)
    ...
    class ImplementationDeclContext(ParserRuleContext):
        ...
        def enterRule(self, listener:ParseTreeListener):
            if hasattr( listener, "enterImplementationDecl" ):
                listener.enterImplementationDecl(self)

        def exitRule(self, listener:ParseTreeListener):
            if hasattr( listener, "exitImplementationDecl" ):
                listener.exitImplementationDecl(self)
